...
public class PhotoPicker {
    ...
    public final static String KEY_SELECTED_PHOTOS_OBJECT = "SELECTED_PHOTOS_OBJECT";

    public final static String EXTRA_MAX_COUNT = "MAX_COUNT";
    public final static String EXTRA_SHOW_CAMERA = "SHOW_CAMERA";
    public final static String EXTRA_SHOW_GIF = "SHOW_GIF";
    public final static String EXTRA_IS_COMPRESS = "IS_COMPRESS";
    public final static String EXTRA_COMPRESS_SIZE = "COMPRESS_SIZE";
    public final static String EXTRA_GRID_COLUMN = "column";
    public final static String EXTRA_ORIGINAL_PHOTOS = "ORIGINAL_PHOTOS";
    public final static String EXTRA_ORIGINAL_PHOTOS_OBJECT = "ORIGINAL_PHOTOS_OBJECT";
    public final static String EXTRA_PREVIEW_ENABLED = "PREVIEW_ENABLED";
    public final static String ADD_STATUS_BAR = "ADD_STATUS_BAR";
    ...
    public static class PhotoPickerBuilder {
        ...
        public void start(@NonNull Activity activity, int requestCode) {
            if (PermissionUtils.checkReadStoragePermission(activity)) {
        ...
        public void start(@NonNull Context context,
            ...
            if (PermissionUtils.checkReadStoragePermission(fragment.getActivity())) {
         ...
         * @return
         */
        public PhotoPickerBuilder setIsCompress(boolean isCompress) {
            mPickerOptionsBundle.putBoolean(EXTRA_IS_COMPRESS, isCompress);
            return this;
        }

        public PhotoPickerBuilder setImageCompressSize(int imageCompressSize) {
            mPickerOptionsBundle.putInt(EXTRA_COMPRESS_SIZE, imageCompressSize);
            return this;
        }
        ...
        public PhotoPickerBuilder setSelectedPhoto(ArrayList<Photo> imagesPhotos) {
            mPickerOptionsBundle.putParcelableArrayList(EXTRA_ORIGINAL_PHOTOS_OBJECT, imagesPhotos);
            return this;
        }
